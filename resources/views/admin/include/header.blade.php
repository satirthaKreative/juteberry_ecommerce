<div class="page-main-header">
    <div class="main-header-right row m-0">
      <div class="main-header-left">
        <div class="logo-wrapper logo-custom-css"><a href="{{ route('administrator.dashboard') }}"><img class="img-fluid" src="{{  asset('backend/pgel-asset/img/logo.png') }}" alt=""></a></div>
        <div class="dark-logo-wrapper"><a href="{{ route('administrator.dashboard') }}"><img class="img-fluid" src="{{  asset('backend/assets/images/logo/dark-logo.png') }}" alt=""></a></div>
        ...
        <ul class="nav-menus">
          ...
          <li class="onhover-dropdown"><i data-feather="message-square"></i>
            <ul class="chat-dropdown onhover-show-div">
              <li>
                <div class="media"><img class="img-fluid rounded-circle me-3" src="{{  asset('backend/assets/images/user/4.jpg') }}" alt="">
          ...
          <li class="onhover-dropdown p-0">
            ...
            <form method="POST" action="{{ route('administrator.logout') }}">
                ...
                <button class="btn btn-primary-light" type="button">
                    <a href="{{ route('administrator.logout') }}"  onclick="event.preventDefault();this.closest('form').submit();">
